...
public class employer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        idField.setText("Entrer code Id");
        ...
        numeroTelField.setBounds(10, 190, 300, 30);
        ...
        agentsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nom", "Prénom", "Type", "Numéro de Téléphone"
            }
        ) {
        ...
        jComboBox1.setForeground(new java.awt.Color(0, 0, 54));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilote", "Docker" }));
        getContentPane().add(jComboBox1);
        jComboBox1.setBounds(10, 130, 300, 30);
